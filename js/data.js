  ...
  itinerary: [
    {
      ...
      items: [
        ...
        { time: "11:04", title: "京都に到着", desc: "京都駅からsequence KYOTO GOJOへ向かい、荷物を預けて身軽にする。", place: "京都駅 → sequence KYOTO GOJO", mapQuery: "京都駅 sequence KYOTO GOJO" },
        { time: "11:45", title: "梨花和服 京都駅前店で着付け", desc: "予約時間に合わせてお店へ。返却時間を確認してから、着物で京都散策へ出る。", place: "梨花和服 京都駅前店", mapQuery: "梨花和服 京都駅前店" },
        { time: "午後", title: "清水寺・伏見稲荷をメインに散策", desc: "清水寺・産寧坂方面と伏見稲荷大社を中心に、着物で写真を撮りながら巡る。余力があれば祇園・鴨川方面へ。", place: "清水寺・伏見稲荷大社", mapQuery: "清水寺 伏見稲荷大社" },
  ...
  decisions: [
    {
      label: "京都",
      title: "梨花和服 京都駅前店",
      when: "DAY1 11:45から着付け",
      detail: "京都駅からsequence KYOTO GOJOに荷物を預けたあと、梨花和服 京都駅前店で着付け。返却時間は当日お店で確認する。",
      choices: [
    ...
    {
      label: "京都",
      title: "清水寺・伏見稲荷をメインに巡る",
      when: "DAY1午後のメイン予定",
      detail: "清水寺・産寧坂方面と伏見稲荷大社を中心に巡る。余力があれば祇園・鴨川方面へ寄る。",
      choices: ["清水寺・産寧坂", "伏見稲荷大社", "余力があれば祇園・鴨川方面"],
      mapQuery: "清水寺 伏見稲荷大社",
    },
  ],
